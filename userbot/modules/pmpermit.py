...
# ========================= CONSTANTS ============================
UNAPPROVED_MSG = (
    "`Hello People, This Is R4Z0RX Bot.\n\n`"
    "R4Z0RX haven't approved you to PM yet.`"
    "`Please wait for Him to look in, He mostly approve PMs.\n\n`"
    "`Till Then Join @WorldBin1 For Help!`")
# =================================================================
